      ...
      content: JSON.stringify(
        {
          ...
          instructions: [
            ...
            `IMPORTANT: Your output must use key "looks" instead of "outfits".`,
            `Each item must include the exact wardrobe "idx" value given in wardrobe_preview.`,
            `Do not invent numbers; copy them exactly.`,
