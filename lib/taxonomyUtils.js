...
const taxonomy = JSON.parse(readFileSync(new URL('./fashionTaxonomy.json', import.meta.url), 'utf8'));

// 🔍 Find which category/subcategory a term belongs to
export function findCategory(term) {
...
export function getAttributes(categoryPath) {
