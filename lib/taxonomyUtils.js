...
// Expanded taxonomy with fuzzy keywords & priority handling
const TAXONOMY = [
  // CLOTHING
  { mainCategory: "Clothing", subCategory: "Tops", keywords: ["t shirt", "tshirt", "shirt", "blouse", "sweater", "hoodie", "top"] },
  { mainCategory: "Clothing", subCategory: "Dresses", keywords: ["dress", "gown", "maxi dress", "mini dress", "cocktail dress", "evening dress", "blouse dress"] },
  { mainCategory: "Clothing", subCategory: "Bottoms", keywords: ["pants", "trouser", "trousers", "chinos", "jeans", "skirt", "shorts", "leggings"] },
  ...
  { mainCategory: "Clothing", subCategory: "Suits", keywords: ["suit", "blazer suit", "formal suit"] },

  // FOOTWEAR
  { mainCategory: "Footwear", subCategory: "Sneakers", keywords: ["sneaker", "trainer", "running shoes", "sports shoes"] },
  { mainCategory: "Footwear", subCategory: "Heels", keywords: ["heel", "heels", "stiletto", "pump", "high heel", "heek", "heeks"] }, // added fuzzy
  { mainCategory: "Footwear", subCategory: "Sandals", keywords: ["sandal", "flip flop", "open feet shoes", "slippers"] },
  { mainCategory: "Footwear", subCategory: "Boots", keywords: ["boot", "ankle boot", "chelsea boot", "combat boot"] },
  ...
  // BAGS (priority over clothing)
  { mainCategory: "Bags", subCategory: "Handbags", keywords: ["handbag", "purse", "shoulder bag", "long strap bag"] }, // long strap → handbag
  { mainCategory: "Bags", subCategory: "Crossbody", keywords: ["crossbody", "sling bag", "messenger bag", "long strap"] }, // long strap → crossbody too
  ...
  { mainCategory: "Bags", subCategory: "Bag Misc", keywords: ["bag"] }, // fallback for any bag mention

  // ACCESSORIES
  { mainCategory: "Accessories", subCategory: "Belts", keywords: ["belt"] },
  { mainCategory: "Accessories", subCategory: "Eyewear", keywords: ["sunglass", "glasses", "goggles", "spectacles"] },
  { mainCategory: "Accessories", subCategory: "Jewelry", keywords: ["bracelet", "necklace", "ring", "earring", "jewel", "pendant", "bangle", "anklet"] },
...
// 🔍 Category finder with bag-priority logic
export function findCategory(input) {
  const text = (input || "").toLowerCase();

  // Bag priority: if "bag" is present anywhere, search only bag taxonomy first
  if (text.includes("bag")) {
    const bagEntry = TAXONOMY.find(
      (entry) => entry.mainCategory === "Bags" && entry.keywords.some((kw) => text.includes(kw))
    );
    if (bagEntry) return bagEntry;
  }
