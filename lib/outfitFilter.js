...
export function fullOutfitScore(items = [], ctx = {}) {
  ...
  // Combine: base score (weighted composite) + scaled footwear + raw penalty/reward
  const total =
    base.total +
    footwear.score * 0.4 +
    penalties.penalty +
  ...
  // Hard-fail: any single penalty worse than -14 kills the outfit regardless of total
